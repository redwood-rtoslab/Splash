...
v_copyin_result
__junk_5_Msg__copyIn(
    c_base base,
    const class ::junk_5::Msg *from,
    struct _junk_5_Msg *to)
{
...
void
__junk_5_Msg__copyOut(
    const void *_from,
    void *_to)
{
    const struct _junk_5_Msg *from = (const struct _junk_5_Msg *)_from;
    class ::junk_5::Msg *to = (class ::junk_5::Msg *)_to;
