...
v_copyin_result
__junk_9_Msg__copyIn(
    c_base base,
    const class ::junk_9::Msg *from,
    struct _junk_9_Msg *to)
{
...
void
__junk_9_Msg__copyOut(
    const void *_from,
    void *_to)
{
    const struct _junk_9_Msg *from = (const struct _junk_9_Msg *)_from;
    class ::junk_9::Msg *to = (class ::junk_9::Msg *)_to;
