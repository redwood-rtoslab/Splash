#ifndef ISOCPP2_JUNK_5_H
#define ISOCPP2_JUNK_5_H

#include "dds/dds.hpp"

#include "junk_5.h"
#include "junk_5SplDcps.h"
...
public:
    ...
    {
        const char *elements[] = {
            "<MetaData version=\"1.0.0\"><Module name=\"junk_5\"><Struct name=\"Msg\"><Member name=\"id\"><Long/></Member>",
...
"<Member name=\"constraint_freshness_gentime\"><LongLong/></Member></Struct></Module></MetaData>"
    ...
    {
        return (copyInFunction) __junk_5_Msg__copyIn;
    }

    static copyOutFunction getCopyOut()
    {
        return (copyOutFunction) __junk_5_Msg__copyOut;
    }
};
}}}
...
template <>
struct topic_type_name<junk_5::Msg>
{
    static std::string value()
    {
        return org::opensplice::topic::TopicTraits<junk_5::Msg>::getTypeName();
    }
};
}}

REGISTER_TOPIC_TYPE(junk_5::Msg)

#endif /* ISOCPP2_JUNK_5_H */
