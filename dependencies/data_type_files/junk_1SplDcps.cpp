...
v_copyin_result
__junk_1_Msg__copyIn(
    c_base base,
    const class ::junk_1::Msg *from,
    struct _junk_1_Msg *to)
{
...
void
__junk_1_Msg__copyOut(
    const void *_from,
    void *_to)
{
    const struct _junk_1_Msg *from = (const struct _junk_1_Msg *)_from;
    class ::junk_1::Msg *to = (class ::junk_1::Msg *)_to;
