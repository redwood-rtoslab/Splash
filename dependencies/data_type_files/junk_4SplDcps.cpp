...
v_copyin_result
__junk_4_Msg__copyIn(
    c_base base,
    const class ::junk_4::Msg *from,
    struct _junk_4_Msg *to)
{
...
void
__junk_4_Msg__copyOut(
    const void *_from,
    void *_to)
{
    const struct _junk_4_Msg *from = (const struct _junk_4_Msg *)_from;
    class ::junk_4::Msg *to = (class ::junk_4::Msg *)_to;
