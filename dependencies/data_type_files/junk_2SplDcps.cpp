...
v_copyin_result
__junk_2_Msg__copyIn(
    c_base base,
    const class ::junk_2::Msg *from,
    struct _junk_2_Msg *to)
{
...
void
__junk_2_Msg__copyOut(
    const void *_from,
    void *_to)
{
    const struct _junk_2_Msg *from = (const struct _junk_2_Msg *)_from;
    class ::junk_2::Msg *to = (class ::junk_2::Msg *)_to;
