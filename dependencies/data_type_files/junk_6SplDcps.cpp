...
v_copyin_result
__junk_6_Msg__copyIn(
    c_base base,
    const class ::junk_6::Msg *from,
    struct _junk_6_Msg *to)
{
...
void
__junk_6_Msg__copyOut(
    const void *_from,
    void *_to)
{
    const struct _junk_6_Msg *from = (const struct _junk_6_Msg *)_from;
    class ::junk_6::Msg *to = (class ::junk_6::Msg *)_to;
