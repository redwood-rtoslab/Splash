...
v_copyin_result
__junk_7_Msg__copyIn(
    c_base base,
    const class ::junk_7::Msg *from,
    struct _junk_7_Msg *to)
{
...
void
__junk_7_Msg__copyOut(
    const void *_from,
    void *_to)
{
    const struct _junk_7_Msg *from = (const struct _junk_7_Msg *)_from;
    class ::junk_7::Msg *to = (class ::junk_7::Msg *)_to;
