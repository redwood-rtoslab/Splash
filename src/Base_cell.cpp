...
int InputDataPort_PB<Data_0,Data_1,Data_2,Data_3,Data_4,Data_5,Data_6,Data_7,Data_8,Data_9>::attach(ProcessingBlock<Data_0,Data_1,Data_2,Data_3,Data_4,Data_5,Data_6,Data_7,Data_8,Data_9>* PB, std::string topic, int topic_number)
{
	if(topic_number==0)
	{
		...
		dds::topic::Topic<Data_0> temp ((*PB).default_dp, topic,(*PB).default_dp.default_topic_qos());
		
		PB->topic0 = &temp;

		dds::sub::DataReader<Data_0> temp2 ((*PB).PB_sub, (*PB->topic0),(*PB).PB_sub.default_datareader_qos());
		IDP_reader0 = &temp2;
		return 1;
	}		
	...
	if(topic_number==1)
	{
		...
		dds::topic::Topic<Data_1> temp ((*PB).default_dp, topic,(*PB).default_dp.default_topic_qos());
	
		PB->topic1 = &temp;
			
		dds::sub::DataReader<Data_1> temp2((*PB).PB_sub, (*PB->topic1),(*PB).PB_sub.default_datareader_qos());
		IDP_reader1 = &temp2;
	...
	if(topic_number==2)
	{
		...
		dds::topic::Topic<Data_2> temp((*PB).default_dp, topic,(*PB).default_dp.default_topic_qos());
	
		PB->topic2 = &temp;
	
		dds::sub::DataReader<Data_2> temp2((*PB).PB_sub, (*PB->topic2),(*PB).PB_sub.default_datareader_qos());
		IDP_reader2 = &temp2;
	...
	if(topic_number==3)
	{
		...
		dds::topic::Topic<Data_3> temp((*PB).default_dp, topic,(*PB).default_dp.default_topic_qos());
		
		PB->topic3 = &temp;

		dds::sub::DataReader<Data_3> temp2((*PB).PB_sub, (*PB->topic3),(*PB).PB_sub.default_datareader_qos());
		IDP_reader3 = &temp2;
		return 1;
	}	
	...
	if(topic_number==4)
	{
		...
		dds::topic::Topic<Data_4> temp((*PB).default_dp, topic,(*PB).default_dp.default_topic_qos());
		
		PB->topic4 = &temp;


		dds::sub::DataReader<Data_4> temp2 ((*PB).PB_sub, (*PB->topic4),(*PB).PB_sub.default_datareader_qos());
		IDP_reader4 = &temp2;
...
int OutputDataPort_PB<Data_0,Data_1,Data_2,Data_3,Data_4,Data_5,Data_6,Data_7,Data_8,Data_9>::attach(ProcessingBlock<Data_0,Data_1,Data_2,Data_3,Data_4,Data_5,Data_6,Data_7,Data_8,Data_9>* PB, std::string topic, int topic_number)
{
	if(topic_number==5)
	{
		printf("Attached ODP0\n");
	
		PB->ODP0 = this;

		printf("Now trying to get the address of this\n");
		printf("Address of this: %d\n",this);
		printf("successfully printed this\n");

		dds::topic::Topic<Data_5> temp((*PB).default_dp,topic,(*PB).default_dp.default_topic_qos());

		PB->topic5 = &temp;		

		dds::pub::DataWriter<Data_5> temp2((*PB).PB_pub,(*PB->topic5),(*PB).PB_pub.default_datawriter_qos());
		ODP_writer0 = &temp2;
	...
	if(topic_number==6)
	{
		printf("Attached ODP1\n");		

		PB->ODP1 = this;
		
		dds::topic::Topic<Data_6> temp((*PB).default_dp,topic,(*PB).default_dp.default_topic_qos());
		
		PB->topic6 = &temp;	

		dds::pub::DataWriter<Data_6> temp2((*PB).PB_pub,(*PB->topic6),(*PB).PB_pub.default_datawriter_qos());
	...
	if(topic_number==7)
	{
		...
		dds::topic::Topic<Data_7> temp((*PB).default_dp,topic,(*PB).default_dp.default_topic_qos());

		PB->topic7 = &temp;		

		dds::pub::DataWriter<Data_7> temp2((*PB).PB_pub,(*PB->topic7),(*PB).PB_pub.default_datawriter_qos());
		ODP_writer2 = &temp2;
	...
	if(topic_number==8)
	{
		...
		dds::topic::Topic<Data_8> temp((*PB).default_dp,topic,(*PB).default_dp.default_topic_qos());
		
		PB->topic8 = &temp;

		dds::pub::DataWriter<Data_8> temp2((*PB).PB_pub,(*PB->topic8),(*PB).PB_pub.default_datawriter_qos());
		ODP_writer3 = &temp2;
	...
	if(topic_number==9)
	{
		...
		dds::topic::Topic<Data_9> temp((*PB).default_dp,topic,(*PB).default_dp.default_topic_qos());
	
		PB->topic9 = &temp;		

		dds::pub::DataWriter<Data_9> temp2((*PB).PB_pub,(*PB->topic9),(*PB).PB_pub.default_datawriter_qos());	
		ODP_writer4 = &temp2;
